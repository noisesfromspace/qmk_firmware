...
[_BASE] = LAYOUT_ortho_5x12( \
  ...
  KC_LCTL,  EXTR,    KC_LGUI,    KC_LALT, PROG,    PROG,    KC_SPC,  KC_SPC,  KC_LALT, KC_LGUI,          KC_PSCR, KC_LCTL
),
...
[_SELECT] = LAYOUT_ortho_5x12( \
  _______,   _______,  _______,   _______, _______, _______, _______, _______, _______,  _______,  _______, _______, \
  _______,   _______,  KC_W,      _______, KC_R,    KC_T,    _______, _______, KC_UP,    _______,  KC_P,    _______, \
...
void brackets_tap_dance_finished(tap_dance_state_t *state, void *user_data) {
    if (state->count == 1) {
        // Singl tap = ]
...
void brackets_tap_dance_reset(tap_dance_state_t *state, void *user_data) {
    // Unregister keys on reset
...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_BRACKETS] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, brackets_tap_dance_finished, brackets_tap_dance_reset) // <-- ADDED
};
